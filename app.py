...
def home():
    ...
    if request.method == 'POST':
        ...
        if prediction_value == 0:
            response = jsonify(message='It is unlikely for the patient to have diabetes!', prediction_value=prediction_value)
        else:
            response = jsonify(message='It is highly likely that the patient already has or will have diabetes!', prediction_value=prediction_value)
